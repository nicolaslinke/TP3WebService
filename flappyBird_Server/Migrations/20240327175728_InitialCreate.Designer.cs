...
namespace flappyBird_Server.Migrations
{
    ...
    [Migration("20240327175728_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("flappyBird_Server.Models.Score", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("flappyBird_Server.Models.Score", b =>
                {
                    b.HasOne("flappyBird_Server.Models.User", "User")
                        .WithMany("Scores")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("flappyBird_Server.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
